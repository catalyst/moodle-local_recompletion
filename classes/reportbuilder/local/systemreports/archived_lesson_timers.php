 ...
 */
class archived_lesson_timers extends system_report {
    /**
    ...
    protected function initialise(): void {
        ...
        $ltentitiy = new lesson_timers();
        $tablealias = $ltentitiy->get_table_alias('local_recompletion_lt');
        $this->add_entity($ltentitiy);

        $this->set_main_table('local_recompletion_lt', $tablealias);
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'lesson_timers:lesson',
            'lesson_timers:starttime',
            'lesson_timers:endtime',
            'lesson_timers:completed',
            'lesson_timers:timemodifiedoffline',
            'lesson_timers:timearchived',
    ...
    protected function add_filters(): void {
        ...
        $ltentity = $this->get_entity('lesson_timers');
        $tablealias = $ltentity->get_table_alias('local_recompletion_lt');
        $this->add_filter((new filter(
            select::class,
            'lessonid',
            new lang_string('pluginname', 'lesson'),
            $ltentity->get_entity_name(),
            "{$tablealias}.lessonid"
        ))
            ->add_joins($this->get_joins())
