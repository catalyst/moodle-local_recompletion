...
/**
 * Archived course module completions report class implementation.
 *
 ...
 */
class archived_course_modules_completions extends system_report {
    /**
    ...
    protected function initialise(): void {
        ...
        $this->set_main_table('local_recompletion_cmc', $tablealias);
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'course_modules_completion:overrideby',
            'course_modules_completion:timemodified',
            'course_modules_completion:timearchived',
