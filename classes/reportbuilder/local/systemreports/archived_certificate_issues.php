...
/**
 * Archived certificate issues report class implementation.
 *
 ...
 */
class archived_certificate_issues extends system_report {
    /**
    ...
    public static function report_visisble(): bool {
        ...
        return array_key_exists('certificate', $enabled);
    }
    ...
    protected function initialise(): void {
        ...
        $this->set_main_table('local_recompletion_cert', $tablealias);
