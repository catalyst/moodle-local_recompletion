 ...
 */
class archived_h5pactivity_attempts extends system_report {
    /**
    ...
    public static function report_visisble(): bool {
        ...
        return array_key_exists('h5pactivity', $enabled);
    }
    ...
    protected function initialise(): void {
        ...
        $this->set_main_table('local_recompletion_h5p', $tablealias);
