...
use local_recompletion\reportbuilder\entities\enrol_lti_users;
use local_recompletion\reportbuilder\helper;
use local_recompletion\reportbuilder\local\filters\user as user_filter;

/**
 * Archived Enrol LTI users report class implementation.
 *
 ...
 */
class archived_enrol_lti_users extends system_report {
    /**
    ...
    public static function report_visisble(): bool {
        ...
        $enabled = $pluginman->get_enabled_plugins('enrol');
        return array_key_exists('lti', $enabled);
    }
    ...
    protected function initialise(): void {
        ...
        $this->set_main_table('local_recompletion_ltia', $tablealias);
    ...
    public function add_columns(): void {
        $columns = [
            ...
            'enrol_lti_users:enrollti',
            'enrol_lti_users:lastgrade',
            'enrol_lti_users:lastaccess',
            'enrol_lti_users:timecreated',
            'enrol_lti_users:timearchived',
