...
$string['privacy:metadata:local_recompletion:timearchived'] = 'The time this record was archived.';
$string['privacy:metadata:local_recompletion_archived'] = 'Record of when a user was archived for a course.';
...
$string['privacy:metadata:local_recompletion_grade_archived'] = 'Record of when a grade was archived.';
$string['privacy:metadata:local_recompletion_grade_archived:gradehistid'] = 'Grade history record ID.';
...
$string['privacy:metadata:local_recompletion_tci_archived'] = 'Record of when a certificate issue was archived.';
$string['privacy:metadata:local_recompletion_tci_archived:certissueid'] = 'Certificate issue ID.';
...
$string['archivedrecords'] = 'Course recompletion archived records';
$string['datasource:local_recompletion_archived'] = 'Record of when a user\'s course records were archived';
$string['entity:local_recompletion_archived'] = 'Record of when a user\'s course records were archived';
$string['entity:local_recompletion_cha'] = 'User\'s archived choice answer records';
$string['entity:local_recompletion_grade_archived'] = 'Archived grades';
$string['entity:local_recompletion_hvp'] = 'Archived HVP content user data';
$string['entity:local_recompletion_la'] = 'Archived lesson attempts';
$string['entity:local_recompletion_lo'] = 'Archived lesson overrides';
$string['entity:local_recompletion_lt'] = 'Archived lesson timers';
$string['entity:local_recompletion_ltia'] = 'Archived LTI enrolments';
$string['entity:local_recompletion_qr'] = 'Archived questionnaire responses';
$string['entity:local_recompletion_tci_archived'] = 'Archived tool certificate issues';
$string['noarchivedrecordsfound'] = 'No archived records found';
$string['report:archived_certificate_issues'] = 'Certificate issues';
$string['report:archived_choice_answers'] = 'Choice answers';
$string['report:archived_course_completions'] = 'Course completions';
$string['report:archived_course_modules_completions'] = 'Course activity completions';
$string['report:archived_coursecertificate_issues'] = 'Course certificate issues';
$string['report:archived_customcert_issues'] = 'Custom certificate issues';
$string['report:archived_enrol_lti_users'] = 'LTI Enrolments';
$string['report:archived_grades'] = 'Grades';
$string['report:archived_h5pactivity_attempts'] = 'H5P attempts';
$string['report:archived_hotpot_attempts'] = 'Hotpot attempts';
$string['report:archived_hvp_content_user_data'] = 'Interactive content user data';
$string['report:archived_lesson_attempts'] = 'Lesson attempts';
$string['report:archived_lesson_grades'] = 'Lesson grades';
$string['report:archived_lesson_overrides'] = 'Lesson overrides';
$string['report:archived_lesson_timers'] = 'Lesson timers';
$string['report:archived_questionnaire_responses'] = 'Questionnaire responses';
$string['report:archived_quiz_attempts'] = 'Quiz attempts';
$string['report:archived_quiz_grades'] = 'Quiz grades';
$string['report:archived_user_records'] = 'All user records';
$string['report:attempt'] = 'Attempt number';
$string['report:bulkdownload_user_records'] = 'Download records as';
$string['report:completionperiod'] = 'Completion period';
$string['report:data'] = 'Data';
$string['report:dataidentifier'] = 'Data type identifier';
$string['report:endtime'] = 'End time';
$string['report:enrollti'] = 'Enrol';
$string['report:enrolstart'] = 'Enrol start';
$string['report:modifiedby'] = 'Modified by';
$string['report:overrideby'] = 'Override by';
$string['report:pagetitle'] = 'Page';
$string['report:question'] = 'Question';
$string['report:rawgrade'] = 'Raw grade';
$string['report:responseid'] = 'Response ID';
$string['report:starttime'] = 'Start time';
$string['report:status'] = 'Status';
$string['report:timearchived'] = 'Time archived';
$string['report:timemodified'] = 'Time modified';
$string['report:timemodifiedoffline'] = 'Time modified offline';
$string['report:timeperiodstr'] = '{$a->start} <br>- <br>{$a->end}';
$string['report:timeseen'] = 'Time seen';
